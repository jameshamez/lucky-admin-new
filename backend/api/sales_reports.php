...
$target_amount = (float) ($target_res['target'] ?? 2000000); // Default target if not set
...
// Standard reports data (reuse some parts from previous)
$response['data']['salesByProductType'] = []; // Placeholder for chart
