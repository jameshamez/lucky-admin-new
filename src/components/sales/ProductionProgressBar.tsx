...
const getStepIndex = (status: string): number => {
  const statusMap: Record<string, number> = {
    // 0: สร้างคำสั่งซื้อใหม่
    "สร้างคำสั่งซื้อใหม่": 0,
    ...
    "กำลังปรับไฟล์ผลิต": 1,
    "รอเซลล์ตรวจแบบป้าย": 1,
    "รอกราฟิกแก้ไขแบบป้าย": 1,
    ...
    // 3: ระหว่างขนส่ง
    "งานเสร็จสมบูรณ์": 3,
    "พิมพ์เอกสารแล้ว - รอจัดส่ง": 3,
    "โรงงานส่งออก": 3,
    "อยู่ระหว่างขนส่ง": 3,
    "ระหว่างขนส่ง": 3,
    "ถึงไทย": 3,
    "ส่งจากโกดัง → ร้าน": 3,
    "ตรวจนับ & QC ที่ร้าน": 3,
